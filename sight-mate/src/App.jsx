    ...
    try {
      const aiResponse = await ai.models.generateContent({
        ...
        contents: `You need to analyze this website: ${request}. 
          ...
          Your response should look like this: "Score: [score from 0 to 100]. (next line) Areas to improve: (next line) 1. (one thing): (short precise explanation 15 words at max) ..." .`
        config: {
          thinkingConfig: {
    ...
    try {
      ...
      const aiResponse = await ai.models.generateContent({
        ...
        contents: [`You need to analyze this website from a screenshot.
          Assess whether this website has low contrast text issues.
          Your response should look like this: "Score: [score from 0 to 100]. (next line) Areas to improve: (next line) 1. (one thing): (short precise explanation at 15 min max) ..." .`,
        config: {
          thinkingConfig: {
          thinkingLevel: ThinkingLevel.medium,
          },
